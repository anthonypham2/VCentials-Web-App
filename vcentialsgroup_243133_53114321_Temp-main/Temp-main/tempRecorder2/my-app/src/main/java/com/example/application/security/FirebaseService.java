...
public class FirebaseService {
    ...
    void init() {
        ...
        try {
            ...
            FileInputStream privateCredentials = new FileInputStream(System.getProperty("user.dir") + "/serviceAccountKey.json"); // Specify the path to your service account JSON file here

            options = FirebaseOptions.builder()
                    .setCredentials(GoogleCredentials.fromStream(privateCredentials))
                    .build();
